/*
 * electric_shielding_model.java
 */

import com.comsol.model.*;
import com.comsol.model.util.*;

/** Model exported on Jul 14 2026, 18:04 by COMSOL 6.4.0.293. */
public class electric_shielding_model {

  public static Model run() {
    Model model = ModelUtil.create("Model");

    model.modelPath("D:\\COMSOL64\\Multiphysics\\applications\\ACDC_Module\\Introductory_Electric_Currents");
    ...
    model.component("comp1").geom("geom1").feature("cyl1").set("ax3", new double[]{1, 0, 0});
    ...
    model.component("comp1").geom("geom1").feature("sel1").label("Electrode");
    ...
    model.component("comp1").material("mat2").label("Sea Water");
    ...
    model.result("pg1").feature("slc1").set("colortable", "Dipole");
